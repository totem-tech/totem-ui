...
const [texts] = translated({
    ...
    emptyMessage: 'No records available for this Activity. Start booking time by cliking the timer button above',
    emptyMessageArchive: 'No records have been archived yet',
    orInviteATeamMember: 'or invite someone to the team',
