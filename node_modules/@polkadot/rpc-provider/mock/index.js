...
var _static = _interopRequireDefault(require("@polkadot/storage/static"));

var _static2 = _interopRequireDefault(require("@polkadot/types/Metadata/v5/static"));
...
class Mock {
  constructor() {
    ...
    this.requests = {
      ...
      'chain_getRuntimeVersion': () => new _types.RuntimeVersion().toHex(),
  ...
  init() {
    ...
    setInterval(() => {
      ...
      newHead = this.makeBlockHeader(newHead.blockNumber.toBn()); // increment the balances and nonce for each account

      keyring.getPairs().forEach((_ref2, index) => {
        let {
          publicKey
        } = _ref2;
        this.setStateBn(_static.default.balances.freeBalance(publicKey), newHead.blockNumber.muln(3).iaddn(index));
        this.setStateBn(_static.default.system.accountNonce(publicKey), newHead.blockNumber.addn(index));
