...
export class App extends ReactiveComponent {
  ...
  toggleMenuItem(index) {
    ...
    items[index].clickedOn = new Date();
            ...
            <Label>
              ...
              <Label.Detail>
                <Rspan className="value">
                  {runtime.core.authorities.mapEach(a => (
                    <Identicon key={a} account={a} size={16} />
                  ))}
                </Rspan>
              </Label.Detail>
            </Label>
          ...
          <Segment style={{ margin: "1em" }} padded>
            <Header as="h2">
              ...
              <Header.Content>
                Address Book
                <Header.Subheader>
                  Inspect the status of any account and name it for later use
                </Header.Subheader>
              </Header.Content>
            </Header>
            <div style={{ paddingBottom: "1em" }}>
                ...
                then={
                  <div>
                    ...
                    <Label>
                      ...
                      <Label.Detail>
                        <Pretty
                          value={runtime.system.accountNonce(this.lookup)}
                        />
                      </Label.Detail>
                    </Label>
                    <Label>
                ...
                then={
                  <span>
                    ...
                    <Label>
                      ...
                      <Label.Detail>
                        <Pretty
                          value={runtime.system.accountNonce(this.source)}
                        />
                      </Label.Detail>
                    </Label>
                  </span>
              ...
              <If
                ...
                then={
                  <Label>
                    ...
                    <Label.Detail>
                      <Pretty
                        value={runtime.balances.balance(this.destination)}
                      />
                    </Label.Detail>
                  </Label>
                }
