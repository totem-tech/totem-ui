...
const textsCap = translated(
	{
		...
		locationRemoveWarning:
			'this location is used by the following identities:',
				...
				[
					...
					},
					{
						...
						inputs: [
							...
							},
							{
								...
								options: arrSort(
									storage.countries.map(
										([_, { code, name }]) => ({
											description: code,
											flag: !noFlags.includes(code)
												? code.toLowerCase()
												: '',
											key: code,
											name,
					...
					this.isUpdate && {
						...
						onClick: () => {
							...
							const identities = getIdentities().filter(
								x => x.locationId === id
							)
							confirm({
