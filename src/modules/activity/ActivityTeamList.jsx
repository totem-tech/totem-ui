...
const textsCap = {
    ...
    addPartner: 'add business partner or individuals',
    emptyMessage: 'No team members are available. Click the invite button to invite business partners or individuals.',
    invite: 'invite',
    invited: 'invited',
    loading: 'loading...',
    status: 'status',
