...
var _MisbehaviorReport = _interopRequireWildcard(require("./MisbehaviorReport"));

// Copyright 2017-2019 @polkadot/types authors & contributors
// This software may be modified and distributed under the terms
// of the Apache-2.0 license. See the LICENSE file for details.
describe('BftAtReport', () => {
  const report = new _MisbehaviorReport.BftAtReport({
    round: 16,
    a: ['0x1234', '0x5678'],
    b: ['0x8765', '0x4321']
  });
...
describe('MisbehaviorReport', () => {
  const report = new _MisbehaviorReport.default({
