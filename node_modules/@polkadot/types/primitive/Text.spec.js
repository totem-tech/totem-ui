...
describe('Text', () => {
  describe('decode', () => {
    const testDecode = (type, input, expected) => it("can decode from ".concat(type), () => {
      expect(new _Text.default(input).toString()).toBe(expected);
    });
  ...
  describe('utils', () => {
    ...
    it('compares actual String values', () => {
      expect(new _Text.default('XYX').eq(new String('XYX'))).toBe(true);
    });
