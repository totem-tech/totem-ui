...
export declare type OnCallDefinition<CodecResult, SubscriptionResult> = (method: OnCallFunction<RxResult, RxResult>, params?: Array<CodecArg>, callback?: CodecCallback, needsCallback?: boolean) => CodecResult | SubscriptionResult;
export declare type OnCallFunction<CodecResult, SubscriptionResult> = (...params: Array<CodecArg>) => CodecResult | SubscriptionResult;
...
export declare type HashResult<CodecResult, SubscriptionResult> = CodecResult extends Observable<any> ? Observable<Hash> : Promise<Hash>;
export declare type U64Result<CodecResult, SubscriptionResult> = CodecResult extends Observable<any> ? Observable<U64> : Promise<U64>;
...
export declare type QueryableStorageFunction<CodecResult, SubscriptionResult> = CodecResult extends Observable<any> ? QueryableStorageFunctionBase<CodecResult, SubscriptionResult> : QueryableStorageFunctionPromise<CodecResult, SubscriptionResult>;
...
export declare type QueryableStorageMultiArg<CodecResult, SubscriptionResult> = QueryableStorageFunction<CodecResult, SubscriptionResult> | [QueryableStorageFunction<CodecResult, SubscriptionResult>, ...Array<CodecArg>];
export declare type QueryableStorageMultiArgs<CodecResult, SubscriptionResult> = Array<QueryableStorageMultiArg<CodecResult, SubscriptionResult>>;
...
export declare type QueryableStorageMulti<CodecResult, SubscriptionResult> = CodecResult extends Observable<any> ? QueryableStorageMultiBase<CodecResult, SubscriptionResult> : QueryableStorageMultiPromise<CodecResult, SubscriptionResult>;
...
export declare type DeriveMethod<CodecResult, SubscriptionResult> = CodecResult extends Observable<any> ? DeriveMethodBase<CodecResult, SubscriptionResult> : DeriveMethodPromise<CodecResult, SubscriptionResult>;
...
export declare type ApiInterface$Rx = ApiInterface$Decorated<RxResult, RxResult>;
export declare type ApiInterface$Events = RpcRxInterface$Events | 'ready';
export declare type ApiType = 'promise' | 'rxjs';
...
export declare type SignerOptions = SignatureOptions & {
    genesisHash: Hash;
};
