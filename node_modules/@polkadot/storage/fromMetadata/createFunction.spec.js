...
describe('createFunction', () => {
  it('should create timestamp.now correctly', () => {
    expect((0, _createFunction.default)('Timestamp', 'Now', {
      type: {}
  ...
  it('allows overrides on key (keeping name)', () => {
    expect((0, _createFunction.default)('Substrate', 'authorityCount', {
      type: {}
    }, {
      key: ':auth:len',
      skipHashing: true
  ...
  describe('the created double map function', () => {
    let storageFn;
    beforeAll(() => {
      storageFn = (0, _createFunction.default)('GenericAsset', 'FreeBalance', {
        name: 'metaName',
        type: {
          isDoubleMap: true,
          asDoubleMap: {
    ...
    it('needs two arguments', () => {
      expect(() => storageFn(['5DXUeE5N5LtkW97F2PzqYPyqNkxqSWESdGSPTX6AvkUAhwKP'])).toThrow(/metaName expects two arguments/);
    });
  });
  it('allows creates double map function with a Null type key', () => {
    const storageFn = (0, _createFunction.default)('System', 'EventTopics', {
      type: {
        isDoubleMap: true,
        asDoubleMap: {
          hasher: new _types.StorageHasher('Blake2_256'),
