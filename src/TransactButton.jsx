...
const {
  ...
  styleStatus
} = require("./TransactionProgressLabel");
  ...
  render() {
    ...
    return (
      <TransactButtonAux
        ...
        disabled={Bond.all([this.props.tx])
          .ready()
          .map(
            txReady => !txReady || this.state.disabled || !this.state.enabled
          )}
...
class TransactButtonAux extends ReactiveComponent {
  ...
  render() {
    ...
    let labelColor =
      (this.props.colorPolicy === "button" && !specialColor
        ? this.props.color
        : null) ||
      statusColor ||
      this.props.color;
    let buttonColor =
      (this.props.colorPolicy === "status" ? statusColor : this.props.color) ||
      this.props.color ||
      statusColor;
    return (
      <Button
        icon={
          this.state.status === null || !clickable ? this.props.icon : "check"
        }
        size={this.props.size}
