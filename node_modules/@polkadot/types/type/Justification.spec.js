...
describe('RhdJustification', () => {
  const just = new _Justification.RhdJustification({
    roundNumber: 32,
    hash: '0xabcd',
    signatures: [['0x1234', '0x5678'], ['0x9876', '0x5432']]
  });
  ...
  it('creates from a JSON strusture', () => {
    const viaRpc = new _Justification.RhdJustification(_SignedBlock.default.result.justification);
    expect(viaRpc.hash.toHex()).toEqual('0xfab4bb3a8b0a072d3d09858dc865ad2750b2e708536b6dacc89fad369eba781a');
  });
});