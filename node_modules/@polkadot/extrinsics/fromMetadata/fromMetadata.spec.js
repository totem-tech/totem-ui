...
var _static = _interopRequireDefault(require("@polkadot/types/Metadata/v5/static"));
...
const metadata = new _types.Metadata(_static.default);
const newExtrinsics = (0, _.default)(metadata);
describe('fromMetadata', () => {
  ...
  it('should return properly-encoded transactions', () => {
    expect(new _types.Extrinsic(newExtrinsics.timestamp.set([10101])).toU8a()).toEqual(new Uint8Array([// length (encoded)
    4 << 2, // version, no signature
    1, // index
    0, 0, // values, Compact<Moment>
    116]));
  });
});