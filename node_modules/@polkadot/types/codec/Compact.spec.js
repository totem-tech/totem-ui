...
var _Moment = _interopRequireDefault(require("../primitive/Moment"));
...
describe('Compact', () => {
  describe('encodeU8a', () => {
    ...
    it('encondes a large balance', () => {
      expect(_Compact.default.encodeU8a(new _Balance.default('0x5af3107a4000'))).toEqual(new Uint8Array([3 + (6 - 4 << 2), 0x00, 0x40, 0x7a, 0x10, 0xf3, 0x5a]));
    });
  });
  describe('decodeU8a', () => {
    it('decoded u8 value', () => {
  ...
  describe('constructor', () => {
    it('has the correct bitLength for constructor values (BlockNumber)', () => {
      expect(new _Compact.default(_BlockNumber.default, 0xfffffff9).bitLength()).toEqual(64);
    });
    it('has the correct encodedLength for constructor values (BlockNumber)', () => {
      expect(new _Compact.default(_BlockNumber.default, 0xfffffff9).encodedLength).toEqual(5);
    });
    ...
    it('constructs properly via number as Moment', () => {
      expect(new _Compact.default(_Moment.default, 1537968546).toString().startsWith('Wed Sep 26 2018') // The time depends on the timezone this test is run in
      ).toBe(true);
    });
  });
  describe('utils', () => {
