...
class ApiRx extends _Base.default {
  ...
  constructor(provider) {
    super(provider, 'rxjs');
    this._isReadyRx = void 0;
    this._isReadyRx = (0, _rxjs.from)( // convinced you can observable from an event, however my mind groks this form better
    new Promise(resolveReady => super.on('ready', () => resolveReady(this))));
  }
  /**
  ...
  clone() {
    return new ApiRx((0, _objectSpread2.default)({}, this._options, {
      source: this
    }));
  }
